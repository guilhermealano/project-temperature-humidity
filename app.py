...
def index():
    ...
    if conn:
        with conn.cursor() as cursor:
            ...
            cursor.execute("SELECT desired_temperature, desired_humidity, TO_CHAR(timestamp AT TIME ZONE 'America/Sao_Paulo', 'YYYY-MM-DD HH24:MI:SS') AS localized_timestamp, desired_temp_min, desired_temp_max FROM sensor_param ORDER BY timestamp DESC LIMIT 1")
